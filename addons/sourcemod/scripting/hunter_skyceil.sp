 ...
 * @Last Modified time: 2024-09-13 01:17:09
...
void Event_PlayerSpawn(Event event, const char[] name, bool dontBroadcast)
{
    ...
    else g_bIsControllable[hunter] = true;
}
