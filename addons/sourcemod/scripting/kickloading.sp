...
public void OnPluginStart()
{
	...
	kickloadstuckers_duration = CreateConVar("kickloadstuckers_duration", "60.0", "Kick player after this many second if they still connecting to server", _, true, 60.0);
}
