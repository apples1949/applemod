...
public void OnPluginStart()
{
	...
	g_h_CvarPushLimit = CreateConVar("l4d2_charger_power_push_limit", "3", "可以撞动铁多少次", FCVAR_NOTIFY, true, 1.0, true, 100.0);
	g_h_CvarRemoveObject = CreateConVar("l4d2_charger_power_remove", "0", "多少时间后删除撞动的铁 (秒)", FCVAR_NOTIFY, true, 0.0, true, 100.0);
	g_h_CvarChargerDamage = CreateConVar("l4d2_charger_power_damage", "60", "Charger撞动铁后扣多少血", FCVAR_NOTIFY, true, 0.0, true, 100.0);
