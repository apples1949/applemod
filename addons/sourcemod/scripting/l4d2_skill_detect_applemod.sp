...
public void OnPluginStart()
{
	...
	if (g_cvarMaxPounceDistance == null)
		g_cvarMaxPounceDistance = CreateConVar("z_pounce_damage_range_max", "1729.2", "Not available on this server, added by l4d2_skill_detect.", FCVAR_NONE, true, 0.0, false);
