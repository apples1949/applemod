...
#define PLUGIN_AUTHOR	   "NoroHime (apples1949 Edible)"
...
public void OnPluginStart()
{
	...
	cDevKey	  = CreateConVar(PLUGIN_NAME... "_devkey", "", "valve 开发者key, 浏览 https://steamcommunity.com/dev 获取", FCVAR_NOTIFY);
	cQueries  = CreateConVar(PLUGIN_NAME... "_queries", "3", "需要获取什么来源的玩家游戏时长 1=steam玩家主页 2=玩家成就页面 3=都获取", FCVAR_NOTIFY);
	...
	cKickTime.AddChangeHook(OnConVarChanged);
...
void
	Announce(int target, int type, const char[] format, any...)
{
	if (!type)
		return;
