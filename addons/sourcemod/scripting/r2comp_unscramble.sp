...
static	Handle:g_hTrine, Handle:g_fwdOnUnscrambleEnd, /*bool:g_bCvarUnlocker,*/ bool:g_bCvarEnabled, bool:g_bCvarNotify, bool:g_bCvarNoVotes, Float:g_fCvarTime, g_iCvarAttempts, bool:g_bCheked[MAXPLAYERS+1], bool:g_bJoinTeamUsed[MAXPLAYERS+1],
...
public OnPluginStart()
{
	...
	#endif
	LoadTranslations("Unscramble.phrases");
	...
	cVar = CreateConVar("rotoblin_unscramble_attempts", "99", "Maximum attempts to try to move player to the team he were.", FCVAR_NOTIFY, true, 1.0, true, 6.0);
...
US_ForceToUnlockTeams()
{
	...
	if (g_bCvarNotify)
		PrintToChatAll("%s %t", MAIN_TAG, "Unscramble completed");
